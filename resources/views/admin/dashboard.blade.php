...
<div class="content">
            ...
            <div class="col-12 col-md-auto">
              <div class="d-flex align-items-center"><span class="fa-stack" style="min-height: 46px;min-width: 46px;"><span class="fa-solid fa-square fa-stack-2x dark__text-opacity-50 text-success-light" data-fa-transform="down-4 rotate--10 left-4"></span><span class="fa-solid fa-circle fa-stack-2x stack-circle text-stats-circle-success" data-fa-transform="up-4 right-3 grow-2"></span><span class="fa-stack-1x fa-solid fa-star text-success " data-fa-transform="shrink-2 up-8 right-6"></span></span>
                <div class="ms-3">
                  ...
                  <p class="mb-0 text-body-secondary fs-9">Awating processing</p>
                </div>
              </div>
            </div>
            <div class="col-12 col-md-auto">
              <div class="d-flex align-items-center"><span class="fa-stack" style="min-height: 46px;min-width: 46px;"><span class="fa-solid fa-square fa-stack-2x dark__text-opacity-50 text-warning-light" data-fa-transform="down-4 rotate--10 left-4"></span><span class="fa-solid fa-circle fa-stack-2x stack-circle text-stats-circle-warning" data-fa-transform="up-4 right-3 grow-2"></span><span class="fa-stack-1x fa-solid fa-pause text-warning " data-fa-transform="shrink-2 up-8 right-6"></span></span>
                <div class="ms-3">
                  ...
                  <p class="mb-0 text-body-secondary fs-9">On hold</p>
                </div>
              </div>
            </div>
            <div class="col-12 col-md-auto">
              <div class="d-flex align-items-center"><span class="fa-stack" style="min-height: 46px;min-width: 46px;"><span class="fa-solid fa-square fa-stack-2x dark__text-opacity-50 text-danger-light" data-fa-transform="down-4 rotate--10 left-4"></span><span class="fa-solid fa-circle fa-stack-2x stack-circle text-stats-circle-danger" data-fa-transform="up-4 right-3 grow-2"></span><span class="fa-stack-1x fa-solid fa-xmark text-danger " data-fa-transform="shrink-2 up-8 right-6"></span></span>
                <div class="ms-3">
                  ...
                  <p class="mb-0 text-body-secondary fs-9">Out of stock</p>
                </div>
              </div>
            </div>
          </div>
          <hr class="mt-4 mb-6 bg-body-secondary" />
          <div class="mb-4 row flex-between-center g-3">
            <div class="col-auto">
              <h3>Total sells</h3>
              <p class="mb-0 text-body-tertiary lh-sm">Payment received across all channels</p>
            </div>
                ...
                <div class="card-body">
                  ...
                  <div class="mt-2">
                    <div class="mb-2 d-flex align-items-center">
                      ...
                      <h6 class="flex-1 mb-0 text-body fw-semibold">Completed</h6>
                      <h6 class="mb-0 text-body fw-semibold">52%</h6>
                    </div>
                    <div class="d-flex align-items-center">
                      <div class="bullet-item bg-primary-subtle me-2"></div>
                      <h6 class="flex-1 mb-0 text-body fw-semibold">Pending payment</h6>
                      <h6 class="mb-0 text-body fw-semibold">48%</h6>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card h-100">
                <div class="card-body">
                  ...
                  <div>
                    <div class="mb-2 d-flex align-items-center">
                      <div class="bullet-item bg-primary me-2"></div>
                      <h6 class="flex-1 mb-0 text-body fw-semibold">Percentage discount</h6>
                      <h6 class="mb-0 text-body fw-semibold">72%</h6>
                    </div>
                    <div class="mb-2 d-flex align-items-center">
                      <div class="bullet-item bg-primary-lighter me-2"></div>
                      <h6 class="flex-1 mb-0 text-body fw-semibold">Fixed card discount</h6>
                      <h6 class="mb-0 text-body fw-semibold">18%</h6>
                    </div>
                    <div class="d-flex align-items-center">
                      <div class="bullet-item bg-info-dark me-2"></div>
                      <h6 class="flex-1 mb-0 text-body fw-semibold">Fixed product discount</h6>
                      <h6 class="mb-0 text-body fw-semibold">10%</h6>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-12 col-md-6">
              <div class="card h-100">
                <div class="card-body d-flex flex-column">
                  ...
                  <div class="flex-1 pt-3 d-flex justify-content-center">
                    <div class="echarts-paying-customer-chart" style="height:100%;width:100%;"></div>
                  </div>
                  <div class="mt-3">
                    <div class="mb-2 d-flex align-items-center">
                      <div class="bullet-item bg-primary me-2"></div>
                      <h6 class="flex-1 mb-0 text-body fw-semibold">Paying customer</h6>
                      <h6 class="mb-0 text-body fw-semibold">30%</h6>
                    </div>
                    <div class="d-flex align-items-center">
                      <div class="bullet-item bg-primary-subtle me-2"></div>
                      <h6 class="flex-1 mb-0 text-body fw-semibold">Non-paying customer</h6>
                      <h6 class="mb-0 text-body fw-semibold">70%</h6>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="px-4 mx-n4 mx-lg-n6 px-lg-6 bg-body-emphasis pt-7 border-y">
      <div data-list='{"valueNames":["product","customer","rating","review","time"],"page":6}'>
        <div class="pb-5 row align-items-end justify-content-between g-3">
          <div class="col-auto">
        ...
        <div class="px-1 table-responsive mx-n1 scrollbar">
          <table class="table mb-0 fs-9 border-top border-translucent">
            <thead>
              <tr>
                <th class="align-middle white-space-nowrap fs-9 ps-0">
                  <div class="mb-0 form-check fs-8"><input class="form-check-input" id="checkbox-bulk-reviews-select" type="checkbox" data-bulk-select='{"body":"table-latest-review-body"}' /></div>
                </th>
                <th class="align-middle sort white-space-nowrap" scope="col"></th>
                <th class="align-middle sort white-space-nowrap" scope="col" style="min-width:360px;" data-sort="product">PRODUCT</th>
                <th class="align-middle sort" scope="col" data-sort="customer" style="min-width:200px;">CUSTOMER</th>
                <th class="align-middle sort" scope="col" data-sort="rating" style="min-width:110px;">RATING</th>
                <th class="align-middle sort" scope="col" style="max-width:350px;" data-sort="review">REVIEW</th>
                <th class="align-middle sort text-start ps-5" scope="col" data-sort="status">STATUS</th>
                <th class="align-middle sort text-end" scope="col" data-sort="time">TIME</th>
                <th class="align-middle sort text-end pe-0" scope="col"></th>
              </tr>
            </thead>
            <tbody class="list" id="table-latest-review-body">
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                <td class="align-middle fs-9 ps-0">
                  <div class="mb-0 form-check fs-8"><input class="form-check-input" type="checkbox" data-bulk-select-row='{"product":"Fitbit Sense Advanced Smartwatch with Tools for Heart Health, Stress Management & Skin Temperature Trends, Carbon/Graphite, One Size (S & L Bands)","productImage":"/products/60x60/1.png","customer":{"name":"Richard Dawkins","avatar":""},"rating":5,"review":"This Fitbit is fantastic! I was trying to be in better shape and needed some motivation, so I decided to treat myself to a new Fitbit.","status":{"title":"Approved","badge":"success","icon":"check"},"time":"Just now"}' /></div>
                </td>
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/1.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">This Fitbit is fantastic! I was trying to be in better shape and needed some motivation, so I decided to treat myself to a new Fitbit.</p>
                </td>
                ...
                <td class="align-middle text-end time white-space-nowrap">
                  <div class="hover-hide">
                    <h6 class="mb-0 text-body-highlight">Just now</h6>
                  </div>
                </td>
                <td class="align-middle white-space-nowrap text-end pe-0">
                  ...
                  <div class="btn-reveal-trigger position-static"><button class="transition-none btn btn-sm dropdown-toggle dropdown-caret-none btn-reveal fs-10" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs-10"></span></button>
                    <div class="py-2 dropdown-menu dropdown-menu-end"><a class="dropdown-item" href="#!">View</a><a class="dropdown-item" href="#!">Export</a>
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/2.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">The order was delivered ahead of schedule. To give us additional time, you should leave the packaging sealed with plastic.</p>
                </td>
                <td class="align-middle text-start ps-5 status"><span class="badge badge-phoenix fs-10 badge-phoenix-success"><span class="badge-label">Approved</span><span class="ms-1" data-feather="check" style="height:12.8px;width:12.8px;"></span></span></td>
                <td class="align-middle text-end time white-space-nowrap">
                  <div class="hover-hide">
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/3.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">It's a Mac, after all. Once you've gone Mac, there's no going back. My first Mac lasted over nine years, and this is my second.</p>
                </td>
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/4.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">Personally, I like the minimalist style, but I wouldn't choose it if I were searching for a computer that I would use frequently. It's...<a href='#!'>See more</a></p>
                </td>
                <td class="align-middle text-start ps-5 status"><span class="badge badge-phoenix fs-10 badge-phoenix-warning"><span class="badge-label">Pending</span><span class="ms-1" data-feather="clock" style="height:12.8px;width:12.8px;"></span></span></td>
                <td class="align-middle text-end time white-space-nowrap">
                  <div class="hover-hide">
                    <h6 class="mb-0 text-body-highlight">Nov 09, 3:23 AM</h6>
                  </div>
                </td>
                <td class="align-middle white-space-nowrap text-end pe-0">
                  <div class="position-relative">
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/5.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">It performs exactly as expected. There are three of these in the family.</p>
                </td>
                <td class="align-middle text-start ps-5 status"><span class="badge badge-phoenix fs-10 badge-phoenix-warning"><span class="badge-label">Pending</span><span class="ms-1" data-feather="clock" style="height:12.8px;width:12.8px;"></span></span></td>
                <td class="align-middle text-end time white-space-nowrap">
                  <div class="hover-hide">
                    <h6 class="mb-0 text-body-highlight">Nov 09, 2:15 PM</h6>
                  </div>
                </td>
                <td class="align-middle white-space-nowrap text-end pe-0">
                  <div class="position-relative">
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/6.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">The controller is quite comfy for me. Despite its increased size, the controller still fits well in my hands.</p>
                </td>
                <td class="align-middle text-start ps-5 status"><span class="badge badge-phoenix fs-10 badge-phoenix-success"><span class="badge-label">Approved</span><span class="ms-1" data-feather="check" style="height:12.8px;width:12.8px;"></span></span></td>
                <td class="align-middle text-end time white-space-nowrap">
                  <div class="hover-hide">
                    <h6 class="mb-0 text-body-highlight">Nov 08, 8:53 AM</h6>
                  </div>
                </td>
                <td class="align-middle white-space-nowrap text-end pe-0">
                  <div class="position-relative">
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/7.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star-half-alt star-icon text-warning"></span></td>
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">The response time and service I received when contacted the designers were Phenomenal!</p>
                </td>
                <td class="align-middle text-start ps-5 status"><span class="badge badge-phoenix fs-10 badge-phoenix-warning"><span class="badge-label">Pending</span><span class="ms-1" data-feather="clock" style="height:12.8px;width:12.8px;"></span></span></td>
                <td class="align-middle text-end time white-space-nowrap">
                  <div class="hover-hide">
                    <h6 class="mb-0 text-body-highlight">Nov 07, 9:00 PM</h6>
                  </div>
                </td>
                <td class="align-middle white-space-nowrap text-end pe-0">
                  <div class="position-relative">
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/8.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">I have started using this theme in the last week and it has really impressed me very much, the support is second to none.</p>
                </td>
                <td class="align-middle text-start ps-5 status"><span class="badge badge-phoenix fs-10 badge-phoenix-warning"><span class="badge-label">Pending</span><span class="ms-1" data-feather="clock" style="height:12.8px;width:12.8px;"></span></span></td>
                <td class="align-middle text-end time white-space-nowrap">
                  <div class="hover-hide">
                    <h6 class="mb-0 text-body-highlight">Nov 07, 11:20 AM</h6>
                  </div>
                </td>
                <td class="align-middle white-space-nowrap text-end pe-0">
                  <div class="position-relative">
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/9.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span></td>
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">The best experience we could hope for. Customer service team is amazing and the quality of their products is unsurpassed. Great theme ...<a href='#!'>See more</a></p>
                </td>
                <td class="align-middle text-start ps-5 status"><span class="badge badge-phoenix fs-10 badge-phoenix-success"><span class="badge-label">Approved</span><span class="ms-1" data-feather="check" style="height:12.8px;width:12.8px;"></span></span></td>
                <td class="align-middle text-end time white-space-nowrap">
                  <div class="hover-hide">
                    <h6 class="mb-0 text-body-highlight">Nov 07, 2:00 PM</h6>
                  </div>
                </td>
                <td class="align-middle white-space-nowrap text-end pe-0">
                  <div class="position-relative">
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/10.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">This template has allowed me to convert my existing web app into a great looking, easy to use UI in less than 2 weeks. Very easy to us...<a href='#!'>See more</a></p>
                </td>
                <td class="align-middle text-start ps-5 status"><span class="badge badge-phoenix fs-10 badge-phoenix-success"><span class="badge-label">Approved</span><span class="ms-1" data-feather="check" style="height:12.8px;width:12.8px;"></span></span></td>
                <td class="align-middle text-end time white-space-nowrap">
                  <div class="hover-hide">
                    <h6 class="mb-0 text-body-highlight">Nov 06, 8:00 AM</h6>
                  </div>
                </td>
                <td class="align-middle white-space-nowrap text-end pe-0">
                  <div class="position-relative">
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/11.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star-half-alt star-icon text-warning"></span></td>
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">The theme is really beautiful and the support answer very quickly and is friendly. Buy it, you will not regret it.</p>
                </td>
                <td class="align-middle text-start ps-5 status"><span class="badge badge-phoenix fs-10 badge-phoenix-warning"><span class="badge-label">Pending</span><span class="ms-1" data-feather="clock" style="height:12.8px;width:12.8px;"></span></span></td>
                <td class="align-middle text-end time white-space-nowrap">
                  <div class="hover-hide">
                    <h6 class="mb-0 text-body-highlight">Nov 05, 4:00 AM</h6>
                  </div>
                </td>
                <td class="align-middle white-space-nowrap text-end pe-0">
                  <div class="position-relative">
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/12.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">As others mentioned, the team behind this theme is super responsive. I sent a message during the weekend, fully expecting a response a...<a href='#!'>See more</a></p>
                </td>
                <td class="align-middle text-start ps-5 status"><span class="badge badge-phoenix fs-10 badge-phoenix-success"><span class="badge-label">Approved</span><span class="ms-1" data-feather="check" style="height:12.8px;width:12.8px;"></span></span></td>
                <td class="align-middle text-end time white-space-nowrap">
                  <div class="hover-hide">
                    <h6 class="mb-0 text-body-highlight">Nov 04, 6:53 PM</h6>
                  </div>
                </td>
                <td class="align-middle white-space-nowrap text-end pe-0">
                  <div class="position-relative">
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/13.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span></td>
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">I had a bit of a hard time at first but after I contacted the team they were able to help me set up the theme. It's really good and I ...<a href='#!'>See more</a></p>
                </td>
                <td class="align-middle text-start ps-5 status"><span class="badge badge-phoenix fs-10 badge-phoenix-warning"><span class="badge-label">Pending</span><span class="ms-1" data-feather="clock" style="height:12.8px;width:12.8px;"></span></span></td>
                <td class="align-middle text-end time white-space-nowrap">
                  <div class="hover-hide">
                    <h6 class="mb-0 text-body-highlight">Nov 04, 12:00 PM</h6>
                  </div>
                </td>
                <td class="align-middle white-space-nowrap text-end pe-0">
                  <div class="position-relative">
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/14.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span></td>
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">Excellent. All my doubts were answered by the team quickly. I highly recommend it.</p>
                </td>
                <td class="align-middle text-start ps-5 status"><span class="badge badge-phoenix fs-10 badge-phoenix-warning"><span class="badge-label">Pending</span><span class="ms-1" data-feather="clock" style="height:12.8px;width:12.8px;"></span></span></td>
                <td class="align-middle text-end time white-space-nowrap">
                  <div class="hover-hide">
                    <h6 class="mb-0 text-body-highlight">Nov 03, 8:53 AM</h6>
                  </div>
                </td>
                <td class="align-middle white-space-nowrap text-end pe-0">
                  <div class="position-relative">
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="py-0 align-middle product white-space-nowrap"><a class="border d-block rounded-2 border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="assets/img/products/60x60/15.png" alt="" width="53" /></a></td>
                ...
                <td class="align-middle review" style="min-width:350px;">
                  <p class="mb-0 fs-9 fw-semibold text-body-highlight">This theme is great. Clean and easy to understand. Perfect for those who don't have time to start everything from scratch. The support...<a href='#!'>See more</a></p>
                </td>
                <td class="align-middle text-start ps-5 status"><span class="badge badge-phoenix fs-10 badge-phoenix-success"><span class="badge-label">Approved</span><span class="ms-1" data-feather="check" style="height:12.8px;width:12.8px;"></span></span></td>
                <td class="align-middle text-end time white-space-nowrap">
                  <div class="hover-hide">
                    <h6 class="mb-0 text-body-highlight">Nov 03, 10:43 AM</h6>
                  </div>
                </td>
                <td class="align-middle white-space-nowrap text-end pe-0">
                  <div class="position-relative">
        ...
        <div class="py-1 row align-items-center">
          ...
          <div class="col-auto d-flex">
            <button class="px-1 btn btn-link me-1" type="button" title="Previous" data-list-pagination="prev"><span class="fas fa-chevron-left me-2"></span>Previous</button><button class="px-1 btn btn-link ms-1" type="button" title="Next" data-list-pagination="next">Next<span class="fas fa-chevron-right ms-2"></span></button>
          </div>
        </div>
      </div>
    </div>
    <footer class="footer position-absolute">
      <div class="row g-0 justify-content-between align-items-center h-100">
        <div class="text-center col-12 col-sm-auto">
          <p class="mt-2 mb-0 mt-sm-0 text-body">Thank you for creating with Phoenix<span class="d-none d-sm-inline-block"></span><span class="mx-1 d-none d-sm-inline-block">|</span><br class="d-sm-none" />2024 &copy;<a class="mx-1" href="https://themewagon.com/">Themewagon</a></p>
        </div>
        <div class="text-center col-12 col-sm-auto">
